...
class AdminDatabaseHandler(DatabaseHandler):
    ...
    def delete_user(self, user_id):
        ...
        logging.info(f"Executing query: {query_services}, {query_cars}, {query_user}")
    ...
    def delete_car(self, car_id):
        ...
        logging.info(f"Executing query: {query_services}, {query_cars}")
        return True
    ...
    def delete_service(self, service_id):
        ...
        logging.info(f"Executing query: {query_services}")
        return True
